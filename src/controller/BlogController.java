...
public class BlogController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response, Blog blog, Object user) throws ServletException, IOException {
